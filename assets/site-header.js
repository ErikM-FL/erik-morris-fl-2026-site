...
(function(){
  ...
  const NAV=[
    ...
    {label:'About Erik',href:'/pages/about-erik.html'}   // NEW
  ];
  ...
  function ensureGlobalAssets(){
    ...
    if(!document.querySelector('link[href*="/assets/site-header.css"]')){
      (document.head||document.body).appendChild(el('link',{rel:'stylesheet',href:'/assets/site-header.css?v=4'}));
    }
    // Animated gradient site-wide
    if(!document.querySelector('link[href*="/assets/animated-gradient.css"]')){
      (document.head||document.body).appendChild(el('link',{rel:'stylesheet',href:'/assets/animated-gradient.css?v=1'}));
    }
  }
