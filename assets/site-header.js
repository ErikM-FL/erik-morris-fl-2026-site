(function(){
  function positionMenu(){
    try{
      ...
      var top  = Math.max(56, rect.bottom + 8);  // place just below header, even if sticky/grid shifts
  ...
  // Whenever the Languages button is toggled, re-position the fixed panel
