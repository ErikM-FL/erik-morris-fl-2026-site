...
(function(){
  ...
  function ensureStyles(){
    if(!document.querySelector('link[href$="/assets/site-header.css"]')){
      (document.head||document.body).appendChild(el('link',{rel:'stylesheet',href:'/assets/site-header.css?v=rollback'}));
    }
  }
  ...
  function build(){
    ...
    inner.append(brandline, images, lang, nav); H.appendChild(inner); anchor.replaceWith(H);
  }
